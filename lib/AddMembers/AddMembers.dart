...
import 'package:cubix/AddMembers/AddMemberLogic.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class CometChatAddMembers extends StatelessWidget {
  CometChatAddMembers({Key? key, required this.group})
  ...
  Widget build(BuildContext context) {
    ...
    final tag = "add_members_tag_${group.guid}";
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: colorPalette.iconPrimary),
          onPressed: () {
                        ...
                        child: (controller.isLoading)
                            ...
                            : Text(
                                ...
                                style: TextStyle(
                                  color: colorPalette.buttonIconColor,
                                  fontSize:
                                      typography.button?.medium?.fontSize ?? 16,
                                  fontFamily:
